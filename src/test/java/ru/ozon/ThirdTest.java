...
public class ThirdTest extends WebDriverSettings {
    ...
    @Step("Проверка того, что цены в диапазоне от 3000 до 4000")
    public static void checkPricesJuicers(String str1, String str2) throws IOException {
        Assert.assertEquals(str1, str2);
        getBytes("juicers1.png");
    }

    @Step("Проверка того, что количество соковыжималок равно 5")
    public static void checkNumberJuicers(String str1, String str2) throws IOException {
        Assert.assertEquals(str1, str2);
        getBytes("juicers2.png");
    }
    ...
    public void thirdTest() throws InterruptedException, IOException {
        ...
        checkPricesJuicers(flag.toString(), "true");
        sleep(1000);
        ...
        sleep(3000);
        WebElement cartButtonChange = driver.findElement(By.xpath(".//span[@class='f-caption--bold bb0']"));
        try {
